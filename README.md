...
For this fork, the authoritative list of currently exposed entities is the
"Fork notes" section above.
...
| External Generator S0 Power                      | W    | the instantaneous power produced by external device connected to S0 in |
...
| Core Temperature                                | °C   | the instantaneous temperature of the inverter core              |
| Heat Sink Temperature                           | °C   | the instantaneous temperature of the inverter heat sink         |
